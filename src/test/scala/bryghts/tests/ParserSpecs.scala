...
class ParserSpecs extends Specification with ScalaCheck
{
	...
	"Parse booleans correctly" in {
		Parser("false")         mustEqual Success(false)
		Parser("true")          mustEqual Success(true)
		Parser(" 	false")     mustEqual Success(false)
		Parser(" 	true")      mustEqual Success(true)
		Parser("false 	")      mustEqual Success(false)
		Parser("true 	")      mustEqual Success(true)
		...
		Parser("fals")   .isFailure       must beTrue
		Parser("tru")    .isFailure       must beTrue
		Parser("true a") .isFailure       must beTrue
		Parser("truea")  .isFailure       must beTrue
		Parser("falsea") .isFailure       must beTrue
		Parser("true ,") .isFailure       must beTrue
		Parser("true }") .isFailure       must beTrue
		Parser("true ]") .isFailure       must beTrue
		Parser("t true") .isFailure       must beTrue
	}

	"Parse null correctly" in {
		Parser("null")          mustEqual Success(null)
		Parser(" 	null")      mustEqual Success(null)
		Parser("null 	")      mustEqual Success(null)
		Parser(" 	null 	")  mustEqual Success(null)

		Parser("nul")          .isFailure       must beTrue
		Parser("null a")       .isFailure       must beTrue
		Parser("nulla")        .isFailure       must beTrue
		Parser("null ,")       .isFailure       must beTrue
		Parser("null }")       .isFailure       must beTrue
		Parser("null ]")       .isFailure       must beTrue
		Parser("t null")       .isFailure       must beTrue
	}

	"Parse Strings correctly" in {
		Parser(""" "abc" """) mustEqual Success(("abc"))
		Parser(" \"ab\\\"c\\\\b\\/b\\byyy\\fyyy\\nyyy\\ryyy\\tyyy\\u0123yyy\\u4567yyy\\u89AByyy\\uCDEFyyy\" ") mustEqual Success(("ab\"c\\b/b\byyy\fyyy\nyyy\ryyy\tyyy\u0123yyy\u4567yyy\u89AByyy\uCDEFyyy"))
		Parser(" \"ab\\\"c\\\\b\\/b\\byyy\\fyyy\\nyyy\\ryyy\\tyyy\\u0123yyy\\u4567yyy\\u89abyyy\\ucdefyyy\" ") mustEqual Success(("ab\"c\\b/b\byyy\fyyy\nyyy\ryyy\tyyy\u0123yyy\u4567yyy\u89AByyy\uCDEFyyy"))

		Parser(" \"\\uABCG\" ") .isFailure       must beTrue
		Parser(" \"\\uABGC\" ") .isFailure       must beTrue
		Parser(" \"\\uAGCC\" ") .isFailure       must beTrue
		Parser(" \"\\uGBCC\" ") .isFailure       must beTrue
	}

	"Parse Numbers correctly" in {
		Parser(""" 0 """) mustEqual Success((0))
		Parser(""" -0 """) mustEqual Success((0))
		Parser(""" 123 """) mustEqual Success((123))
		Parser(""" -123 """) mustEqual Success((-123))

		Parser(""" 0.0 """) mustEqual Success((0))
		Parser(""" -0.0 """) mustEqual Success((0))
		Parser(""" 123.0 """).get.asInstanceOf[Double] must beCloseTo (123.0, 0.000000001)
		Parser(""" -123.0 """).get.asInstanceOf[Double] must beCloseTo (-123, 0.000000001)

		Parser(""" 0.123 """).get.asInstanceOf[Double] must beCloseTo (0.123, 0.000000001)
		Parser(""" -0.123 """).get.asInstanceOf[Double] must beCloseTo (-0.123, 0.000000001)
		Parser(""" 123.123 """).get.asInstanceOf[Double] must beCloseTo (123.123, 0.000000001)
		Parser(""" -123.123 """).get.asInstanceOf[Double] must beCloseTo (-123.123, 0.000000001)




		Parser(""" 0e12 """).get.asInstanceOf[Double] must beCloseTo (0e12, 0.000000001e12)
		Parser(""" -0e12 """).get.asInstanceOf[Double] must beCloseTo (0e12, 0.000000001e12)
		Parser(""" 123e12 """).get.asInstanceOf[Double] must beCloseTo (123e12, 0.000000001e12)
		Parser(""" -123e12 """).get.asInstanceOf[Double] must beCloseTo (-123e12, 0.000000001e12)

		Parser(""" 0.0e12 """).get.asInstanceOf[Double] must beCloseTo (0e12, 0.000000001e12)
		Parser(""" -0.0e12 """).get.asInstanceOf[Double] must beCloseTo (0e12, 0.000000001e12)
		Parser(""" 123.0e12 """).get.asInstanceOf[Double] must beCloseTo (123e12, 0.000000001e12)
		Parser(""" -123.0e12 """).get.asInstanceOf[Double] must beCloseTo (-123e12, 0.000000001e12)

		Parser(""" 0.123e12 """).get.asInstanceOf[Double] must beCloseTo (0.123e12, 0.000000001e12)
		Parser(""" -0.123e12 """).get.asInstanceOf[Double] must beCloseTo (-0.123e12, 0.000000001e12)
		Parser(""" 123.123e12 """).get.asInstanceOf[Double] must beCloseTo (123.123e12, 0.000000001e12)
		Parser(""" -123.123e12 """).get.asInstanceOf[Double] must beCloseTo (-123.123e12, 0.000000001e12)




		Parser(""" 0e-12 """).get.asInstanceOf[Double] must beCloseTo (0e-12, 0.000000001e-12)
		Parser(""" -0e-12 """).get.asInstanceOf[Double] must beCloseTo (0e-12, 0.000000001e-12)
		Parser(""" 123e-12 """).get.asInstanceOf[Double] must beCloseTo (123e-12, 0.000000001e-12)
		Parser(""" -123e-12 """).get.asInstanceOf[Double] must beCloseTo (-123e-12, 0.000000001e-12)

		Parser(""" 0.0e-12 """).get.asInstanceOf[Double] must beCloseTo (0e-12, 0.000000001e-12)
		Parser(""" -0.0e-12 """).get.asInstanceOf[Double] must beCloseTo (0e-12, 0.000000001e-12)
		Parser(""" 123.0e-12 """).get.asInstanceOf[Double] must beCloseTo (123e-12, 0.000000001e-12)
		Parser(""" -123.0e-12 """).get.asInstanceOf[Double] must beCloseTo (-123e-12, 0.000000001e-12)

		Parser(""" 0.123e-12 """).get.asInstanceOf[Double] must beCloseTo (0.123e-12, 0.000000001e-12)
		Parser(""" -0.123e-12 """).get.asInstanceOf[Double] must beCloseTo (-0.123e-12, 0.000000001e-12)
		Parser(""" 123.123e-12 """).get.asInstanceOf[Double] must beCloseTo (123.123e-12, 0.000000001e-12)
		Parser(""" -123.123e-12 """).get.asInstanceOf[Double] must beCloseTo (-123.123e-12, 0.000000001e-12)
		...
		Parser(""" 0E12 """).get.asInstanceOf[Double] must beCloseTo (0E12, 0.000000001e+12)
		Parser(""" -0E12 """).get.asInstanceOf[Double] must beCloseTo (0E12, 0.000000001e+12)
		Parser(""" 123E12 """).get.asInstanceOf[Double] must beCloseTo (123E12, 0.000000001e+12)
		Parser(""" -123E12 """).get.asInstanceOf[Double] must beCloseTo (-123E12, 0.000000001e+12)

		Parser(""" 0.0E12 """).get.asInstanceOf[Double] must beCloseTo (0E12, 0.000000001e+12)
		Parser(""" -0.0E12 """).get.asInstanceOf[Double] must beCloseTo (0E12, 0.000000001e+12)
		Parser(""" 123.0E12 """).get.asInstanceOf[Double] must beCloseTo (123E12, 0.000000001e+12)
		Parser(""" -123.0E12 """).get.asInstanceOf[Double] must beCloseTo (-123E12, 0.000000001e+12)

		Parser(""" 0.123E12 """).get.asInstanceOf[Double] must beCloseTo (0.123E12, 0.000000001e+12)
		Parser(""" -0.123E12 """).get.asInstanceOf[Double] must beCloseTo (-0.123E12, 0.000000001e+12)
		Parser(""" 123.123E12 """).get.asInstanceOf[Double] must beCloseTo (123.123E12, 0.000000001e+12)
		Parser(""" -123.123E12 """).get.asInstanceOf[Double] must beCloseTo (-123.123E12, 0.000000001e+12)
...
//		Parser(" 00 ")    .isFailure       must beTrue
		Parser(" +1 ")    .isFailure       must beTrue
		Parser(" .0 ")    .isFailure       must beTrue
		Parser(" 12ee1 ") .isFailure       must beTrue
	}

	"Parse Arrays" in {
		Parser(""" [] """) mustEqual Success(Vector())
		Parser(""" [1, 2, 3] """) mustEqual Success(Vector(1, 2, 3))
		Parser(""" [1, true, "3"] """) mustEqual Success(Vector(1, true, "3"))
	}

	"Parse Objects" in {
		Parser(""" {} """) mustEqual Success(Map())
		Parser(""" {"name" : "John", "age" : 32, "emails" : ["a@gmail.com", "b@gmail.com"]} """) mustEqual Success(Map("name" -> "John", "age" -> 32, "emails" -> Vector("a@gmail.com", "b@gmail.com")))
	}
	...
	"Parse Sample Values" in {
		val json =
			"""
			  ...
			  |}
			""".stripMargin
		Parser(json) mustEqual Success(Map(
			"glossary" -> Map (
				"title" -> "example glossary",
				"GlossDiv" -> Map(
					"title" -> "S",
